...
for i, item in enumerate(
    [
        ...
        BacklogItem(name="HelloChinese", tasks="", tags={"Language Study"}),
        BacklogItem(name="Deep Learning from First Principles In Vectorized Python R and Octave", tasks="", tags={""}),
        BacklogItem(name="Guide to NumPy (2006)", tasks="", tags={"python", "c"}),
        BacklogItem(name="https://exercism.org/tracks/python", tasks="", tags={""}),
        BacklogItem(name="Tiny Python Projects", tasks="", tags={""}),
        BacklogItem(name="Автоматизация рутинных задач с помощью Python", tasks="", tags={""}),
        BacklogItem(name="Python. Сборник упражнений", tasks="", tags={""}),
        BacklogItem(name="Python. Книга рецептов", tasks="", tags={""}),
        BacklogItem(name="Python. Разработка на основе тестирования", tasks="", tags={""}),
        BacklogItem(name="Machine Learning - An Applied Mathematics Introduction", tasks="", tags={""}),
        BacklogItem(name="Introduction to Statistical Learning", tasks="", tags={""}),
        BacklogItem(name="INTO_IT: C Programmieren trainieren! - YouTube", tasks="", tags={""}),
        BacklogItem(name="Le langage C", tasks="", tags={""}),
        BacklogItem(name="Mastering C++ Programming Language", tasks="", tags={""}),
        BacklogItem(name="Programmieren in C - YouTube C Tutorials Deutsch", tasks="", tags={""}),
        BacklogItem(name="Sams Teach Yourself C++ in One Hour a Day (2022)", tasks="", tags={""}),
        BacklogItem(name="The C++ Standard Library. A Tutorial and Reference", tasks="", tags={""}),
        BacklogItem(name="https://exercism.org/tracks/cpp", tasks="", tags={""}),
        BacklogItem(name="Conceitos de computação com o essencial de C++", tasks="", tags={""}),
        BacklogItem(name="C++. Lernen und professionell anwenden", tasks="", tags={""}),
        BacklogItem(name="Экстремальный Си", tasks="", tags={""}),
        BacklogItem(name="Экстремальный Си", tasks="", tags={""}),
        BacklogItem(name="The C++ Programming Language", tasks="", tags={""}),
        BacklogItem(name="100 algoritmos C++", tasks="", tags={""}),
        BacklogItem(name="Algoritmos em Linguagem C", tasks="", tags={""}),
        BacklogItem(name="Решение задач на современном C++", tasks="", tags={""}),
        BacklogItem(name="Cpp Notes for Professionals", tasks="", tags={""}),
        BacklogItem(name="Cpp Programming. Program Design Including Data Structures", tasks="", tags={""}),
        BacklogItem(name="Design Patterns in Modern C++", tasks="", tags={""}),
        BacklogItem(name="Design Patterns in Modern C++20", tasks="", tags={""}),
        BacklogItem(name="Hands-On Design Patterns with Cpp", tasks="", tags={""}),
        BacklogItem(name="Il linguaggio C (Deitel)", tasks="", tags={""}),
        BacklogItem(name="Open Data Structures (in C++)", tasks="", tags={""}),
        BacklogItem(name="Programming Principles and Practices C++", tasks="", tags={""}),
        BacklogItem(name="Думай как программист - C++", tasks="", tags={""}),
        BacklogItem(name="C++ для профи", tasks="", tags={""}),
        BacklogItem(name="Guide to Competitive Programming", tasks="", tags={""}),
        BacklogItem(name="C – kurz & gut", tasks="", tags={""}),
        BacklogItem(name="Clean C++", tasks="", tags={""}),
        BacklogItem(name="Оптимизация программ на C++", tasks="", tags={""}),
        BacklogItem(name="Функциональное программирование на языке C++", tasks="", tags={""}),
        BacklogItem(name="Алгоритмические трюки для программистов", tasks="", tags={""}),
        BacklogItem(
            name="Beautiful Cpp. 30 Core Guidelines for Writing Clean, Safe, and Fast Code", tasks="", tags={""}
        ),
        BacklogItem(name="Inteligencia artificial avanzada", tasks="", tags={""}),
        BacklogItem(name="C und Linux", tasks="", tags={""}),
        BacklogItem(name="Data Structures and Algorithm  Analysis in C++", tasks="", tags={""}),
        BacklogItem(name="Effective C++ (140)", tasks="", tags={""}),
        BacklogItem(name="Effective Modern C++", tasks="", tags={""}),
        BacklogItem(name="Expert C++", tasks="", tags={""}),
        BacklogItem(name="Practical C++ Design", tasks="", tags={""}),
        BacklogItem(name="Programación en C, C++, Java y UML", tasks="", tags={""}),
        BacklogItem(name="Software Architecture with C++", tasks="", tags={""}),
        BacklogItem(name="String Algorithms in C", tasks="", tags={""}),
        BacklogItem(name="Безопасное программирование на C и C++", tasks="", tags={""}),
        BacklogItem(name="Introduction to Programming in Java. An Interdisciplinary Approach", tasks="", tags={""}),
        BacklogItem(name="Java Cookbook", tasks="", tags={"java"}),
        BacklogItem(name="Java for Data Science", tasks="", tags={"java"}),
        BacklogItem(name="Java Programming (Farrell)", tasks="", tags={"java"}),
        BacklogItem(name="Java Programming. From The Ground Up", tasks="", tags={"java"}),
        BacklogItem(name="Java для начинающих", tasks="", tags={"java"}),
        BacklogItem(name="Java полное руководство", tasks="", tags={"java"}),
        BacklogItem(name="Java. A Beginner's Guide", tasks="", tags={"java"}),
        BacklogItem(name="Java. Справочник разработчика", tasks="", tags={"java"}),
        BacklogItem(name="Java.djvu", tasks="", tags={"java"}),
        BacklogItem(name="Mastering Java. A Beginner's Guide", tasks="", tags={"java"}),
        BacklogItem(
            name="Mastering Java. An Effective Project Based Approach (including Web)", tasks="", tags={"java"}
        ),
        BacklogItem(name="Введение в объектно-ориентированный дизайн с Java", tasks="", tags={"java"}),
        BacklogItem(name="Джава. Решение практических задач", tasks="", tags={"java"}),
        BacklogItem(name="Java Pocket Guide", tasks="", tags={"java"}),
        BacklogItem(name="Java by Comparison. Become a Java Craftsman in 70 Examples", tasks="", tags={"java"}),
        BacklogItem(name="Java Succinctly Part 2", tasks="", tags={"java"}),
        BacklogItem(
            name="Java and the Java Virtual Machine Definition, Verification, Validation",
            tasks="",
            tags={"java", "jvm"},
        ),
        BacklogItem(name="Java Virtual Machine", tasks="", tags={"java", "jvm"}),
        BacklogItem(name="Modern Java in Action", tasks="", tags={"java"}),
        BacklogItem(
            name="Principles of Computer Organization and Assembly Language Using the JavaTM Virtual Machine",
            tasks="",
            tags={"java", "jvm"},
        ),
        BacklogItem(name="Programming for the Java Virtual Machine", tasks="", tags={"java", "jvm"}),
        BacklogItem(name="The Java® Virtual Machine Specification", tasks="", tags={"java", "jvm"}),
        BacklogItem(name="Well-Grounded Java Developer", tasks="", tags={"java"}),
        BacklogItem(name="Система модулей Java", tasks="", tags={"java"}),
        BacklogItem(name="Современный Java 2020", tasks="", tags={"java"}),
        BacklogItem(
            name="Объектно-ориентированное программирование на Java. Платформа Java SE",
            tasks="",
            tags={"java", "jvm"},
        ),
        BacklogItem(name="Структуры данных и алгоритмы Java", tasks="", tags={"java"}),
        BacklogItem(name="Decompiling Java", tasks="", tags={"java", "jvm"}),
        BacklogItem(
        ...
        BacklogItem(
            name="“A simple framework for contrastive learning of visual representations.”", tasks="", tags={""}
        ),
        BacklogItem(name="Kevin Knight: Bayesian Inference with Tears, 2009.", tasks="", tags={""}),
        BacklogItem(
        ...
        BacklogItem(
            name="“Efficientnet: Rethinking model scaling for convolutional neural networks.”", tasks="", tags={""}
        ),
        BacklogItem(
        ...
        BacklogItem(
            name="Yoon Kim: Convolutional Neural Networks for Sentence Classification, 2014.", tasks="", tags={""}
        ),
        BacklogItem(
        ...
        BacklogItem(name="Christopher Olah: Understanding LSTM Networks, 2015.", tasks="", tags={""}),
        BacklogItem(
            name="Matthew E. Peters, et al.: Deep contextualized word representations, 2018.", tasks="", tags={""}
        ),
        BacklogItem(
        ...
        BacklogItem(name="“AdderNet: Do we really need multiplications in deep learning?.”", tasks="", tags={""}),
        BacklogItem(
            name="Peter F Brown, et al.: Class-Based n-gram Models of Natural Language, 1992.", tasks="", tags={""}
        ),
        BacklogItem(
        ...
        BacklogItem(name="“Alias-free generative adversarial networks.”", tasks="", tags={""}),
        BacklogItem(
            name="Jeffrey Pennington, et al.: GloVe: Global Vectors for Word Representation, 2014.",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="Ryan Kiros, et al.: Skip-Thought Vectors, 2015.", tasks="", tags={""}),
        BacklogItem(
            name="Piotr Bojanowski, et al.: Enriching Word Vectors with Subword Information, 2017.",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="Daniel Cer et al.: Universal Sentence Encoder, 2018.", tasks="", tags={""}),
        BacklogItem(name="“Transparency and reproducibility in artificial intelligence.”", tasks="", tags={""}),
        BacklogItem(name="Thomas Hofmann: Probabilistic Latent Semantic Indexing, SIGIR 1999.", tasks="", tags={""}),
        BacklogItem(
        ...
        BacklogItem(name="“On the Measure of Intelligence.”", tasks="", tags={""}),
        BacklogItem(
        ...
        BacklogItem(name="Why do linear SVMs trained on HOG features perform so well?", tasks="", tags={"Papers"}),
        BacklogItem(name="Yoon Kim, et al.: Character-Aware Neural Language Models, 2015.", tasks="", tags={"Papers"}),
        BacklogItem(
        ...
        BacklogItem(name="Eugene Charniak: A Maximum-Entropy-Inspired Parser, NAACL 2000.", tasks="", tags={"Papers"}),
        BacklogItem(
        ...
        BacklogItem(name="Oriol Vinyals, et al.: Grammar as a Foreign Language, 2015.", tasks="", tags={"Papers"}),
        BacklogItem(
        ...
        BacklogItem(name="Kevin Knight: A Statistical MT Tutorial Workbook, 1999.", tasks="", tags={"Papers"}),
        BacklogItem(
        ...
        BacklogItem(name="Oriol Vinyals, Quoc Le: A Neural Conversation Model, 2015.", tasks="", tags={"Papers"}),
        BacklogItem(
        ...
        BacklogItem(name="Ashish Vaswani, et al.: Attention Is All You Need, 2017.", tasks="", tags={"Papers"}),
        BacklogItem(
        ...
        BacklogItem(
            name="Kenton Lee at al.: End-to-end Neural Coreference Resolution, EMNLP 2017.", tasks="", tags={"Papers"}
        ),
        BacklogItem(
        ...
        BacklogItem(name="CoNLL-X shared task on multilingual dependency parsing.", tasks="", tags={"Papers"}),
        BacklogItem(
            name="Coarse-to-fine n-best parsing and MaxEnt discriminative reranking.", tasks="", tags={"Papers"}
        ),
        BacklogItem(
        ...
        BacklogItem(name="WordNet: An electronic lexical database. 1998.", tasks="", tags={"Papers"}),
        BacklogItem(name="Accurate unlexicalized parsing.", tasks="", tags={"Papers"}),
        BacklogItem(name="Automatic retrieval and clustering of similar words.", tasks="", tags={"Papers"}),
        BacklogItem(name="Building a large annotated corpus of English: The Penn Treebank.", tasks="", tags={"Papers"}),
        BacklogItem(name="The proposition bank: An annotated corpus of semantic roles.", tasks="", tags={"Papers"}),
        BacklogItem(name="BLEU: a method for automatic evaluation of machine translation.", tasks="", tags={"Papers"}),
        BacklogItem(name="Improved Inference for Unlexicalized Parsing.", tasks="", tags={"Papers"}),
        BacklogItem(name="3Blue1Brown Differential Equations", tasks="", tags={""}),
        BacklogItem(name="Mathematik", tasks="", tags={""}),
        BacklogItem(name="Principles of Mathematical Analysis (Rudin)", tasks="", tags={""}),
        BacklogItem(name="Videos: Socratica Abstract Algebra Playlist", tasks="", tags={""}),
        BacklogItem(name="Linear Algebra Done Right (Axler)", tasks="", tags={""}),
        BacklogItem(name="Linear Algebra (Insel, Freidberg, Spence - problems)", tasks="", tags={""}),
        BacklogItem(name="Videos: Sheldon Axler’s Playlist", tasks="", tags={""}),
        BacklogItem(name="Introduction to Linear Algebra, Fourth Edition by Gilbert Strang", tasks="", tags={""}),
        BacklogItem(name="Basic Linear Algebra (Blyth & Robertson)", tasks="", tags={""}),
        BacklogItem(name="MIT Open Courseware Video Lectures - Linear Algebra by Gilbert Strang", tasks="", tags={""}),
        BacklogItem(name="Geometry by Roger Fenn", tasks="", tags={""}),
        BacklogItem(name="Metric Spaces (O'Searcoid)", tasks="", tags={""}),
        BacklogItem(name="Measure, Integral and Probability (Capinski & Kopp, 2E)", tasks="", tags={""}),
        BacklogItem(name="MIT OCW Measure and Integration", tasks="", tags={""}),
        BacklogItem(name="A First Course in Probability (Ross)", tasks="", tags={""}),
        BacklogItem(name="Schaum's Outline of Probability and Statistics", tasks="", tags={""}),
        BacklogItem(name="Probability and Statistics by Example: Volume 1 (Suhov & Kelbert)", tasks="", tags={""}),
        BacklogItem(name="Statistical Inference (Casella & Berger)", tasks="", tags={""}),
        BacklogItem(name="Real Analysis: Lectures by Professor Francis Su", tasks="", tags={""}),
        BacklogItem(name="Understanding Analysis (Abbott)", tasks="", tags={""}),
        BacklogItem(name="Videos: MAT137 Playlist", tasks="", tags={""}),
        BacklogItem(name="Real Analysis (Howie)", tasks="", tags={""}),
        BacklogItem(name="Topology through Inquiry (Su & Starbird)", tasks="", tags={""}),
        BacklogItem(name="Essential Topology (Crossley)", tasks="", tags={""}),
        BacklogItem(name="Videos: WhyBMaths", tasks="", tags={""}),
        BacklogItem(name="Foundations of Applied Mathematics", tasks="", tags={""}),
        BacklogItem(
            name="https://pnp.mathematik.uni-stuttgart.de/igt/eiserm/lehre/Lineare-Algebra/", tasks="", tags={""}
        ),
        BacklogItem(name="Vector Calculus (Matthews)", tasks="", tags={""}),
        BacklogItem(name="3Blue1Brown Neural Networks", tasks="", tags={""}),
        BacklogItem(name="Statistical Rethinking 2022", tasks="", tags={""}),
        BacklogItem(name="Measure Theory and Probability (MathematicalMonk)", tasks="", tags={""}),
        BacklogItem(name="Mathematical Tripos examination questions in IB Statistics", tasks="", tags={""}),
        BacklogItem(
            name="Div, Grad, Curl, and All That: An Informal Text on Vector Calculus (Schey)", tasks="", tags={""}
        ),
        BacklogItem(name="MIT OCW Multivariable Calculus", tasks="", tags={""}),
        BacklogItem(name="Think Bayes. Bayesian Statistics in Python", tasks="", tags={""}),
        BacklogItem(name="Think stats", tasks="", tags={""}),
        BacklogItem(name="Байесовская статистика", tasks="", tags={""}),
        BacklogItem(name="Classic Algebra by P.M. Cohn", tasks="", tags={""}),
        BacklogItem(
            name="Matlab - A Practical Introduction to Programming and Problem Solving (Attaway 3E)",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="Online Notes: MAT327 Course Notes", tasks="", tags={""}),
        BacklogItem(name="Problems: MAT 327 Course Problems", tasks="", tags={""}),
        BacklogItem(name="Videos: Point Set Topology Playlist", tasks="", tags={""}),
        BacklogItem(name="Algebraic Topology Playlist", tasks="", tags={""}),
        BacklogItem(
            name="Concrete Abstract Algebra: From Numbers to Gröbner Bases by N. Lauritzen", tasks="", tags={""}
        ),
        BacklogItem(name="Contemporary Abstract Algebra (Gallian)", tasks="", tags={""}),
        BacklogItem(name="Introduction to Manifolds (Tu, for rigor)", tasks="", tags={""}),
        BacklogItem(name="Groups (Jordan & Jordan)", tasks="", tags={""}),
        BacklogItem(name="Schaum's Outline of Group Theory (Baumslag & Chandle)", tasks="", tags={""}),
        BacklogItem(name="Groups, Rings and Fields (Wallace)", tasks="", tags={""}),
        BacklogItem(name="Online Notes: MAT327 Course Notes <>", tasks="", tags={""}),
        BacklogItem(
        ...
        BacklogItem(
            name="MIT Open CourseWare Video Lectures - Differential Equations by Arthur Mattuck", tasks="", tags={""}
        ),
        BacklogItem(
        ...
        BacklogItem(name="Differential Equations with Boundary Value Problems (Zill & Cullen)", tasks="", tags={""}),
        BacklogItem(name="An Introduction to Ordinary Differential Equations (Robinson)", tasks="", tags={""}),
        BacklogItem(name="Visual Complex Analysis (Needham, for intuition)", tasks="", tags={""}),
        BacklogItem(name="Analysis of a Complex Kind (Petra Bonfert-Taylor)", tasks="", tags={""}),
        BacklogItem(name="A Geometric Approach to Differential Forms (Bachman, for intuition)", tasks="", tags={""}),
        BacklogItem(name="Differential Equations", tasks="", tags={""}),
        BacklogItem(
            name="Ordinary Differential Equations: Analysis, Qualitative Theory and Control (Logemann & Ryan)",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="Scalar, Vector, and Matrix Mathematics", tasks="", tags={""}),
        BacklogItem(name="Machine Learning Engineering in Action", tasks="", tags={""}),
        BacklogItem(name="Machine Learning Engineering with MLFlow (Hank and (Elsie)", tasks="", tags={""}),
        BacklogItem(name="Machine Learning Engineering", tasks="", tags={""}),
        BacklogItem(name="Параллельные и высокопроизводительные вычисления", tasks="", tags={""}),
        BacklogItem(name="Deep Learning Illustrated", tasks="", tags={""}),
        BacklogItem(name="Deep Learning for Coders with Fastai and PyTorch", tasks="", tags={""}),
        BacklogItem(name="Machine Learning Hands-on for Developers and Technical Professionals", tasks="", tags={""}),
        BacklogItem(name="Mastering Machine Learning Algorithms", tasks="", tags={""}),
        BacklogItem(name="Transfer Learning", tasks="", tags={""}),
        BacklogItem(name="Math for Deep Learning. What You Need to Know", tasks="", tags={""}),
        BacklogItem(name="Thoughtful Machine Learning with Python", tasks="", tags={""}),
        BacklogItem(name="Глубокое обучение в картинках", tasks="", tags={""}),
        BacklogItem(name="Redes neuronales & deep learning", tasks="", tags={""}),
        BacklogItem(name="Data Scientists at Work", tasks="", tags={""}),
        BacklogItem(name="Машинное обучение с участием человека", tasks="", tags={""}),
        BacklogItem(name="GPT-2", tasks="", tags={""}),
        BacklogItem(name="“Tabular data: Deep learning is not all you need.”", tasks="", tags={""}),
        BacklogItem(name="Universal Language Model Fine-tuning for Text Classification", tasks="", tags={""}),
        BacklogItem(name="Improving Language Understanding by Generative Pre-Training", tasks="", tags={""}),
        BacklogItem(name="Learning an Executable Neural Semantic Parser", tasks="", tags={""}),
        BacklogItem(name="https://blog.codinghorror.com/recommended-reading-for-developers/", tasks="", tags={""}),
        BacklogItem(name="200 frases - Noruego - Español", tasks="", tags={""}),
        BacklogItem(name="Aprender yidis", tasks="", tags={""}),
        BacklogItem(name="Colloquial Arabic (Levantine)", tasks="", tags={""}),
        BacklogItem(name="Full-Stack Python Security", tasks="", tags={""}),
        BacklogItem(name="Modern Python Cookbook", tasks="", tags={""}),
        BacklogItem(name="Linux Bible", tasks="", tags={""}),
        BacklogItem(
            name="The TCP,IP Guide. A Comprehensive, Illustrated Internet Protocols Reference", tasks="", tags={""}
        ),
        BacklogItem(name="Программирование GPU при помощи Python и CUDA", tasks="", tags={""}),
        BacklogItem(name="Deep Learning with PyTorch Step-by-Step", tasks="", tags={""}),
        BacklogItem(
            name="Neural Networks https://www.youtube.com/watch?v=CqOfi41LfDw&list=PLblh5JKOoLUIxGDQs4LFFD--41Vzf-ME1",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="PyTorch Pocket Reference", tasks="", tags={""}),
        BacklogItem(name="PyTorch Basics for Absolute Beginners.epub", tasks="", tags={""}),
        BacklogItem(name="The Supervised Learning Workshop", tasks="", tags={""}),
        BacklogItem(name="Глубокое обучение 1 (Гласснер)", tasks="", tags={""}),
        BacklogItem(name="Глубокое обучение 2 (Гласснер)", tasks="", tags={""}),
        BacklogItem(name="Data science from Scratch 2e", tasks="", tags={""}),
        BacklogItem(
        ...
        BacklogItem(name="Еще более эффективный Agile", tasks="", tags={""}),
        BacklogItem(name="Карьера программиста", tasks="", tags={""}),
        BacklogItem(name="Mathematics for Machine Learning", tasks="", tags={""}),
        BacklogItem(name="“A ConvNet for the 2020s.”", tasks="", tags={""}),
        BacklogItem(name="Unsupervised Compositionality Prediction of Nominal Compounds", tasks="", tags={""}),
        BacklogItem(
            name="Automatic Inference of Sound Correspondence Patterns across Multiple Languages", tasks="", tags={""}
        ),
        BacklogItem(
        ...
        BacklogItem(name="Parsing Chinese Sentences with Grammatical Relations", tasks="", tags={""}),
        BacklogItem(name="300 verbos + Leer y escuchar: - Noruego + Español", tasks="", tags={""}),
        BacklogItem(name="Modern Cpp Tutorial", tasks="", tags={""}),
        BacklogItem(name="Программирование на С", tasks="", tags={""}),
        BacklogItem(name="Программирование на языке Cpp", tasks="", tags={""}),
        BacklogItem(name="Hands-On Machine Learning with C++", tasks="", tags={""}),
        BacklogItem(name="C++ українською", tasks="", tags={""}),
        BacklogItem(name="Cpp for Lazy Programmers", tasks="", tags={""}),
        BacklogItem(name="Cpp20 for Programmers", tasks="", tags={""}),
        BacklogItem(name="Discovering Modern C++", tasks="", tags={""}),
        BacklogItem(name="Exploring C++20", tasks="", tags={""}),
        BacklogItem(name="Corso di informatica 1. Linguaggio C e Cpp", tasks="", tags={""}),
        BacklogItem(name="Corso di informatica 2. Linguaggio C e Cpp", tasks="", tags={""}),
        BacklogItem(name="Tour of C++", tasks="", tags={""}),
        BacklogItem(name="A Book on C", tasks="", tags={""}),
        BacklogItem(name="The C++ Workshop", tasks="", tags={""}),
        BacklogItem(name="Computational Thinking | MIT 18.S191/6.S083 Spring 2021", tasks="", tags={""}),
        BacklogItem(name="Computational Thinking | MIT 18.S191/6.S083 Spring 2023", tasks="", tags={""}),
        BacklogItem(name="Data Science with Julia", tasks="", tags={""}),
        BacklogItem(
        ...
        BacklogItem(name="Julia 1.7", tasks="", tags={""}),
        BacklogItem(name="Julia Express", tasks="", tags={""}),
        BacklogItem(name="Julia for Data Science", tasks="", tags={""}),
        BacklogItem(name="Julia for R Programmers", tasks="", tags={""}),
        BacklogItem(name="Julia Language. A Concise Tutorial", tasks="", tags={""}),
        BacklogItem(name="Julia Programming Projects", tasks="", tags={""}),
        BacklogItem(name="Julia", tasks="", tags={""}),
        BacklogItem(name="Learn Julia by building a number guessing game!", tasks="", tags={""}),
        BacklogItem(name="Learning Julia", tasks="", tags={""}),
        BacklogItem(name="Mastering Julia", tasks="", tags={""}),
        BacklogItem(name="Statistics with Julia", tasks="", tags={""}),
        BacklogItem(name="Осваиваем язык Julia", tasks="", tags={""}),
        BacklogItem(name="https://exercism.org/tracks/julia", tasks="", tags={""}),
        BacklogItem(name="https://docs.python.org/3/library/ctypes.html", tasks="", tags={""}),
        BacklogItem(name="Physics", tasks="", tags={""}),
        BacklogItem(name="PoissonNote.dvi - PoissonNote", tasks="", tags={""}),
        BacklogItem(name="Proof of existence and proof of uniqueness of determinant", tasks="", tags={""}),
        BacklogItem(
            name="Prove 8 statements in the key theorem of LA (All the Math You Missed, 1.6)", tasks="", tags={""}
        ),
        BacklogItem(name="Operating system for beginners || Operating system basics - YouTube", tasks="", tags={""}),
        BacklogItem(name="https://wiki.archlinux.org/title/Installation_guide", tasks="", tags={""}),
        BacklogItem(
            name="https://linux-audit.com/elf-binaries-on-linux-understanding-and-analysis/", tasks="", tags={""}
        ),
        BacklogItem(
        ...
        BacklogItem(name="On Mathematical Maturity (1) Thomas Garrity - YouTube", tasks="", tags={""}),
        BacklogItem(name="Fast Inverse Square Root — A Quake III Algorithm - YouTube", tasks="", tags={""}),
        BacklogItem(
            name="Operating System Full Course | Operating System Tutorials for Beginners - YouTube",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="Assembler #1 Hello-World zur Maschinensprache", tasks="", tags={""}),
        BacklogItem(name="Assembler #2 Wie speichert man eine Konsoleneingabe?", tasks="", tags={""}),
        BacklogItem(name="Operating Systems: Crash Course Computer Science #18 - YouTube", tasks="", tags={""}),
        BacklogItem(
            name="Operating System Full Course || Operating System for IT Support - YouTube", tasks="", tags={""}
        ),
        BacklogItem(name="https://www.youtube.com/watch?v=jAGIuobLp60", tasks="", tags={""}),
        BacklogItem(name="https://www.youtube.com/watch?v=LFKZLXVO-Dg", tasks="", tags={""}),
        BacklogItem(name="Neural Network from scratch-part 1 | AI Summer", tasks="", tags={""}),
        BacklogItem(name="https://contentlab.io/c-neural-network-in-a-weekend/", tasks="", tags={""}),
        BacklogItem(
            name="That unbelievable function that can compute EVERYTHING! An Adventure in Discrete Mathematics - YouTube",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="We're Building Computers Wrong - YouTube", tasks="", tags={""}),
        BacklogItem(
            name="https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-004-computation-structures-spring-2017/c10/",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="Turingmaschinen - YouTube", tasks="", tags={""}),
        BacklogItem(name="https://github.com/0xAX/asm", tasks="", tags={""}),
        BacklogItem(name="https://cs.lmu.edu/~ray/notes/nasmtutorial/", tasks="", tags={""}),
        BacklogItem(name="1000 Linux Questions & Answers", tasks="", tags={""}),
        BacklogItem(
            name="https://booking.ai/theres-more-to-experimentation-than-a-b-223fba846876", tasks="", tags={""}
        ),
        BacklogItem(name="http://www.norvig.com/design-patterns/design-patterns", tasks="", tags={""}),
        BacklogItem(name="So you want to write an interpreter?", tasks="", tags={""}),
        BacklogItem(name="WebAssembly (WASM) verdrängt Docker?! // deutsch", tasks="", tags={""}),
        BacklogItem(name="https://fuchsia.dev/", tasks="", tags={""}),
        BacklogItem(
            name="https://medium.com/@brianwill/unix-userland-should-be-replaced-5605fe47cac0", tasks="", tags={""}
        ),
        BacklogItem(name="https://medium.com/@brianwill", tasks="", tags={""}),
        BacklogItem(
            name="https://pilvinen.github.io/notes-on-why-oop-is-bad-and-how-to-solve-it.html", tasks="", tags={""}
        ),
        BacklogItem(name="https://developer.ibm.com/articles/l-gas-nasm/", tasks="", tags={""}),
        BacklogItem(name="Games RL", tasks="", tags={""}),
        BacklogItem(name="What Happens when I Press a Key?", tasks="", tags={""}),
        BacklogItem(name="AES", tasks="", tags={""}),
        BacklogItem(name="OOP", tasks="", tags={""}),
        BacklogItem(name="Why Rust?", tasks="", tags={""}),
        BacklogItem(name="Railroad", tasks="", tags={""}),
        BacklogItem(name="Was sind Monaden? Funktionale Programmierung", tasks="", tags={""}),
        BacklogItem(name="Why would a python programmer learn rust when there are no jobs in it", tasks="", tags={""}),
        BacklogItem(name="https://github.com/gnulinuxpro/infra/", tasks="", tags={""}),
        BacklogItem(name="RabbitMQ Crash Course", tasks="", tags={""}),
        BacklogItem(
            name="RabbitMQ Introduction | RabbitMQ Tutorial for Beginners | What is RabbitMQ | RabbitMQ Message Broker",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="Configuration as Code in Bamboo - Atlassian Summit Europe 2017", tasks="", tags={""}),
        BacklogItem(name="https://www.freecodecamp.org/news/the-docker-handbook/", tasks="", tags={""}),
        BacklogItem(
        ...
        BacklogItem(name="10 Design Patterns Explained in 10 Minutes - YouTube", tasks="", tags={""}),
        BacklogItem(name="RabbitMQ Crash Course - YouTube", tasks="", tags={""}),
        BacklogItem(name="Microservice APIs: With examples in Python (MEAP v10)", tasks="", tags={""}),
        BacklogItem(name="RabbitMQ in 5 minutes", tasks="", tags={""}),
        BacklogItem(name="https://www.youtube.com/watch?v=fl_AelgaWKE", tasks="", tags={""}),
        BacklogItem(name="Learn Docker in 7 Easy Steps - Full Beginner's Tutorial - YouTube", tasks="", tags={""}),
        BacklogItem(
            name="The 50 Most Popular Linux & Terminal Commands - Full Course for Beginners - YouTube",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="Docker Tutorial #1 - Warum ihr Docker braucht! - YouTube", tasks="", tags={""}),
        BacklogItem(name="Cloud Computing. Concepts and Technologies.epub", tasks="", tags={""}),
        BacklogItem(name="Cloud Native Python", tasks="", tags={""}),
        BacklogItem(
            name="Generic Pipelines Using Docker. The DevOps Guide to Building Reusable, Platform Agnostic CI_CD",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="Hands-On RESTful Python Web Services", tasks="", tags={""}),
        BacklogItem(name="Practical Web Scraping for Data Scientists", tasks="", tags={""}),
        BacklogItem(name="Python и DevOps", tasks="", tags={""}),
        BacklogItem(name="Python. Непрерывная интеграция и доставка", tasks="", tags={""}),
        BacklogItem(name="RabbitMQ Essentials", tasks="", tags={""}),
        BacklogItem(name="RabbitMQ in Depth", tasks="", tags={""}),
        BacklogItem(
            name="Web API Development with Python. A Beginner's Guide using Flask and FastAPI", tasks="", tags={""}
        ),
        BacklogItem(
            name="Облачные архитектуры разработка устойчивых и экономичных облачных приложений", tasks="", tags={""}
        ),
        BacklogItem(name="От монолита к микросервисам", tasks="", tags={""}),
        BacklogItem(
            name="Networks, Crowds, and Markets: Reasoning about a Highly Connected World", tasks="", tags={""}
        ),
        BacklogItem(name="Learning at Lambert Labs", tasks="", tags={""}),
        BacklogItem(name="LaTeX 2e for class and package writers", tasks="", tags={""}),
        BacklogItem(
            name="LaTeX Users Guide and Reference Manual. A Document Preparation System (Lamport)",
            tasks="",
            tags={""},
        ),
        BacklogItem(name="TeX by Topic, A TeXnician's Reference", tasks="", tags={""}),
        BacklogItem(name="The TeXbook", tasks="", tags={""}),
        BacklogItem(name="Algorithms for Decision Making", tasks="", tags={""}),
        BacklogItem(name="Angewandte Mathematik 1 mit MATLAB und Julia", tasks="", tags={""}),
        BacklogItem(name="Angewandte Mathematik 2 mit MATLAB und Julia", tasks="", tags={""}),
        BacklogItem(name="Beginning Julia Programming for Engineers and Scientists", tasks="", tags={""}),
        BacklogItem(name="Foundation Dynamic Web Pages with Python", tasks="", tags={""}),
        BacklogItem(name="Getting Started with Julia Programming", tasks="", tags={""}),
        BacklogItem(name="Hands-on Design Patterns and Best Practices with Julia", tasks="", tags={""}),
        BacklogItem(name="https://julia.quantecon.org/intro.html", tasks="", tags={""}),
        BacklogItem(name="https://pnp.mathematik.uni-stuttgart.de/igt/eiserm/lehre/Topolywood/", tasks="", tags={""}),
        BacklogItem(name="Open Data Structures (in Java)", tasks="", tags={""}),
        BacklogItem(name="Seven Languages in Seven Weeks", tasks="", tags={""}),
        BacklogItem(name="Seven More Languages in Seven Weeks", tasks="", tags={""}),
        BacklogItem(name="Understanding Cryptography", tasks="", tags={""}),
        BacklogItem(name="ГЕОМЕТРИЯ В КАРТИНКАХ", tasks="", tags={""}),
        BacklogItem(name="Коротко о языке программирования Julia", tasks="", tags={""}),
        BacklogItem(name="Шпаргалки для начинающего верстальщика HTML CSS", tasks="", tags={""}),
        BacklogItem(
            name="ЯЗЫК ПРОГРАММИРОВАНИЯ МАТЕМАТИЧЕСКИХ ВЫЧИСЛЕНИЙ JULIA. БАЗОВОЕ РУКОВОДСТВО", tasks="", tags={""}
        ),
        BacklogItem(name="https://exercism.org/tracks/scala", tasks="", tags={""}),
        BacklogItem(name="https://exercism.org/tracks/go", tasks="", tags={""}),
        BacklogItem(name="ACOUSTIC PARAMETERS VERSUS PHONETIC FEATURES IN ASR", tasks="", tags={""}),
        BacklogItem(name="https://exercism.org/tracks/scheme", tasks="", tags={""}),
        BacklogItem(name="https://exercism.org/tracks/fortran", tasks="", tags={""}),
        BacklogItem(name="Modern Fortran", tasks="", tags={""}),
        BacklogItem(name="Das Gehirn", tasks="", tags={""}),
        BacklogItem(name="Kognitive Neurowissenschaften", tasks="", tags={""}),
        BacklogItem(name="Neurobiologie", tasks="", tags={""}),
        BacklogItem(name="Neuromythologie", tasks="", tags={""}),
        BacklogItem(name="Psycholinguistik - Neurolinguistik", tasks="", tags={""}),
        BacklogItem(name="Мозг, познание, разум I", tasks="", tags={""}),
        BacklogItem(name="Мозг, познание, разум II", tasks="", tags={""}),
        BacklogItem(name="Fascism: A Very Short Introduction", tasks="", tags={""}),
        BacklogItem(name="Free Will: A Very Short Introduction", tasks="", tags={""}),
        BacklogItem(name="Freedom Regained: The Possibility of Free Will", tasks="", tags={""}),
        BacklogItem(name="Gehirn und Geist Spezial", tasks="", tags={""}),
        BacklogItem(name="German Philosophy: A Very Short Introduction (Elsie)", tasks="", tags={""}),
        BacklogItem(name="History: A Very Short Introduction (Elsie)", tasks="", tags={""}),
        BacklogItem(name="Kant & Co. im Interview", tasks="", tags={""}),
        BacklogItem(name="Motherland: a philosophical history of Russia", tasks="", tags={""}),
        BacklogItem(name="The Palgrave Handbook of the Psychology of Sexuality and Gender", tasks="", tags={""}),
        BacklogItem(name="The Philosophy of Sex", tasks="", tags={""}),
        BacklogItem(name="Кухня Робинсона.djvu", tasks="", tags={""}),
        BacklogItem(name="Один на один с природой", tasks="", tags={""}),
        BacklogItem(name="Проста фізика.epub", tasks="", tags={""}),
        BacklogItem(name="Lehrbuch Kognitive Neurowissenschaften", tasks="", tags={""}),
        BacklogItem(name="Мозг, познание, разум", tasks="", tags={""}),
        BacklogItem(name="Философия DevOps", tasks="", tags={""}),
        BacklogItem(name="Осваиваем Kubernetes", tasks="", tags={""}),
        BacklogItem(name="Социальная инженерия и социальные хакеры", tasks="", tags={""}),
        BacklogItem(name="Субстанция мышления", tasks="", tags={""}),
        BacklogItem(name="МАТЕМАТИЧЕСКАЯ ЛОГИКА И ТЕОРИЯ АЛГОРИТМОВ", tasks="", tags={""}),
        BacklogItem(name="Программирование. Python. C++. Часть 1.djvu", tasks="", tags={""}),
        BacklogItem(name="Программирование. Python. C++. Часть 2.djvu", tasks="", tags={""}),
        BacklogItem(name="Программирование. Python. C++. Часть 3.djvu", tasks="", tags={""}),
        BacklogItem(name="Программирование. Python. C++. Часть 4.djvu", tasks="", tags={""}),
        BacklogItem(name="50 Shades of JavaScript", tasks="", tags={"javascript"}),
        BacklogItem(name="Aprendendo JavaScript", tasks="", tags={"javascript"}),
        BacklogItem(name="Beginning Topology", tasks="", tags={""}),
        BacklogItem(name="ES6 и не только", tasks="", tags={""}),
        BacklogItem(name="GNU Linux programación de sistemas", tasks="", tags={""}),
        BacklogItem(name="Hands-On System Programming with Linux", tasks="", tags={""}),
        BacklogItem(name="Introduction to Topology", tasks="", tags={""}),
        BacklogItem(name="Intuitive Concepts in Elementary Topology", tasks="", tags={""}),
        BacklogItem(name="JavaScript Succinctly", tasks="", tags={"javascript"}),
        BacklogItem(name="JavaScript для детей", tasks="", tags={"javascript"}),
        BacklogItem(name="JavaScript для профессиональных веб-разработчиков", tasks="", tags={"javascript"}),
        BacklogItem(name="JavaScript на примерах", tasks="", tags={"javascript"}),
        BacklogItem(name="JavaScript с нуля 2021", tasks="", tags={"javascript"}),
        BacklogItem(name="JavaScript. The Definitive Guide", tasks="", tags={"javascript"}),
        BacklogItem(name="JavaScript. Полное руководство", tasks="", tags={"javascript"}),
        BacklogItem(name="Professional JavaScript for Web Developers, 4th Edition", tasks="", tags={"javascript"}),
        BacklogItem(name="https://exercism.org/tracks/javascript", tasks="", tags={"javascript"}),
        BacklogItem(name="Rediscovering JavaScript", tasks="", tags={"javascript"}),
        BacklogItem(name="Познакомьтесь, JavaScript 2е (Симпсон)", tasks="", tags={"javascript"}),
        BacklogItem(name="The JavaScript Way", tasks="", tags={"javascript"}),
        BacklogItem(name="Topologie 2020", tasks="", tags={""}),
        BacklogItem(name="Topology Illustrated", tasks="", tags={""}),
        BacklogItem(name="Topology: A Very Short Introduction (Elsie)", tasks="", tags={""}),
        BacklogItem(name="TypeScript ES", tasks="", tags={""}),
        BacklogItem(name="Understanding Topology. A Practical Introduction", tasks="", tags={""}),
        BacklogItem(name="WebAssembly в действии", tasks="", tags={""}),
        BacklogItem(name="Искусство WebAssembly", tasks="", tags={""}),
        BacklogItem(name="Математика в огне", tasks="", tags={""}),
        BacklogItem(name="Наглядный CSS", tasks="", tags={""}),
        BacklogItem(name="Отзывчивый дизайн на HTML5 и CSS3 для любых устройств 3е", tasks="", tags={""}),
        BacklogItem(name="Программируй & типизируй", tasks="", tags={""}),
        BacklogItem(name="Разработка веб-приложений", tasks="", tags={""}),
        BacklogItem(name="ТОПОЛОГІЯ МНОГОВИДІВ", tasks="", tags={""}),
        BacklogItem(name="https://exercism.org/tracks/r", tasks="", tags={""}),
        BacklogItem(name="Numerical Methods in Science and Engineering", tasks="", tags={""}),
        BacklogItem(name="Cassandra. The Definitive Guide", tasks="", tags={""}),
        BacklogItem(name="Graph Databases", tasks="", tags={""}),
        BacklogItem(name="Hadoop. The Definitive Guide", tasks="", tags={""}),
        BacklogItem(name="High Performance Spark", tasks="", tags={""}),
        BacklogItem(name="Learning Spark", tasks="", tags={""}),
        BacklogItem(name="Practical Machine Learning with H2O", tasks="", tags={""}),
        BacklogItem(name="Time Series Databases", tasks="", tags={""}),
        BacklogItem(name="An introduction to language processing with Perl and Prolog", tasks="", tags={""}),
        BacklogItem(name="An Overview of Lexical Semantics", tasks="", tags={""}),
        BacklogItem(name="Analytical Methods for Interpretable Ultradense Word Embeddings", tasks="", tags={""}),
        BacklogItem(name="Kotlin в действии", tasks="", tags={""}),
        BacklogItem(name="Android Slides", tasks="", tags={""}),
        BacklogItem(name="Kotlin for Android App Development", tasks="", tags={""}),
        BacklogItem(name="Practical Android. 14 Complete Projects", tasks="", tags={""}),
        BacklogItem(name="https://exercism.org/tracks/racket", tasks="", tags={""}),
        BacklogItem(name="https://exercism.org/tracks/elixir", tasks="", tags={""}),
        BacklogItem(name="https://exercism.org/tracks/erlang", tasks="", tags={""}),
        BacklogItem(name="Practical Deep Learning for Cloud, Mobile, & Edge", tasks="", tags={""}),
        BacklogItem(name="Understanding Machine Learning", tasks="", tags={""}),
        BacklogItem(name="Foundations of Machine Learning", tasks="", tags={""}),
        BacklogItem(name="Foundaions of Machine Learning", tasks="", tags={""}),
        BacklogItem(name="Introduction to Machine Learning (Alpaydin)", tasks="", tags={""}),
        BacklogItem(name="Inteligencia artificial", tasks="", tags={""}),
        BacklogItem(name="Python Machine Learning Blueprints", tasks="", tags={""}),
        BacklogItem(name="Python и наука о данных", tasks="", tags={""}),
    ]
):
    g.backlog.update({i: item})
